...
const Timeline = () => {
  document.title = "Timeline | Psymate - Management Portal";
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted">
                        Every team project can have a Psymate. Use the Psymate
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      <h5>Psymate admin dashboard templates layout upload</h5>
                      <p className="text-muted">
                  ...
                  <div className="timeline-item right">
                    ...
                    <div className="content">
                      <h5>
                        New ticket received{" "}
                        <span className="badge bg-soft-success text-success fs-11 align-middle ms-1">
                          Completed
                        </span>
                      </h5>
                      <p className="text-muted mb-2">
                  ...
                  <div className="timeline-continue">
                    ...
                    <Row className="timeline-right">
                      ...
                      <Col xs={12}>
                        <div className="timeline-box">
                          <div className="timeline-text">
                            <h5>Psymate - Project Discussion</h5>
                            <p className="text-muted mb-0">

...
//import action
import { addTeamData as onAddTeamData, updateTeamData as onUpdateTeamData } from "../../../store/team/action";
...
const TeamDoc = () => {
  ...
  const handleDeleteTeamData = () => {
    ...
    if (team) {
      axios.delete(`/user/delete?id=${team._id}`).then((res) => {
        toggle();
              ...
              <Row className="g-2">
                ...
                <Col className="col-sm-auto ms-auto">
                  <div className="list-grid-nav hstack gap-1">
                    ...
                    <UserProfileForm openForm={registerPopUp} closeForm={closeForm} type={type} />
                                ...
                                onClick={(e) => {
                                  ...
                                  if (isEdit) {
                                    axios.put(`/user/${state._id}`, state).then((res) => {
                                      toggle();
                                      toast.success(`${state.displayName} Updated`);
                                      dispatch(getUsers(type, 1, `search=${type}&searchBy=type`));
                                    });
                                  } else {
                                    axios

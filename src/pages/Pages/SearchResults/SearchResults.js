...
const SearchResults = () => {
  document.title = "Search Results | Psymate - Management Portal";
                    ...
                    <TabPane tabId="1">
                      <div className="pb-3">
                        <h5 className="mb-1 fs-16">
                          <Link to="#">
                            Psymate - Responsive Bootstrap 5 Admin Dashboard
                          </Link>
                        </h5>
                        <p className="text-success mb-2">
                          https://themesbrand.com/Psymate/index.html
                        </p>
                        <p className="text-muted mb-2">
                          Psymate admin is super flexible, powerful, clean,
                          ...
                          Psymate it is very quick and easy as it is beautiful,
                      ...
                      <div className="py-3">
                        <h5 className="mb-1 fs-16">
                          <Link to="#">
                            Skote - Admin & Dashboard Template by Psymate Tech
                          </Link>
                        </h5>
                        <p className="text-success mb-2">

...
import { deleteVideo, getVideo } from "../apiTimes";
...
const GetVideo = (props) => {
  ...
  */
  ...
  async function fetchData(page) {
    try {
      const videoData = await getVideo(page,searchKeyword);
              ...
              <div className="d-flex align-items-center">
                ...
                <div className="flex-grow-1">
                  <h5 className="fs-14 mb-1">
                    <Link
                      to={`/teams-add-video?id=${course.row.original._id}`}
                      className="text-dark"
                    >
          ...
          return (
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                ...
                <DropdownItem
                  href={`/teams-add-video?id=${cellProps.row.original._id}`}
                >
  ...
  return (
    <div className="page-content">
      ...
      />
      <Container fluid>
        <BreadCrumb title="Video" pageTitle="Outreach" />
        {/* <Col xs={4}>
          <div className="mb-3">
                ...
                <div className="col-sm-12">
                  <div className="d-flex justify-content-start gap-2">
                    <div className="search-box me-2 col-sm-10">
                      <Input type="text" className="form-control" placeholder="Search for Video..." value={searchKeyword} onChange={handleSearchInputChange} />
                      <i className="ri-search-line search-icon"></i>
                    </div>
                  </div>
                </div>

...
import { deleteArticle, getArticles } from "../apiTimes";
...
const AddArticle = (props) => {
  ...
  */
  ...
  async function fetchData(page) {
    try {
      const articleData = await getArticles(page,searchKeyword);
  ...
  const onClickDelete = async (course) => {
    ...
    // setDeleteModal(true);
    await deleteArticle(course._id);
    setCourse(course);
              ...
              <div className="d-flex align-items-center">
                ...
                <div className="flex-grow-1">
                  <h5 className="fs-14 mb-1">
                    <Link
                      to={`/teams-add-articles?id=${course.row.original._id}`}
                      className="text-dark"
                    >
          ...
          return (
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                ...
                <DropdownItem
                  href={`/teams-add-articles?id=${cellProps.row.original._id}`}
                >
  ...
  return (
    <div className="page-content">
      ...
      />
      <Container fluid>
        <BreadCrumb title="Article" pageTitle="Outreach" />
        {/* <Col xs={4}>
          <div className="mb-3">
                ...
                <div className="col-sm-12">
                  <div className="d-flex justify-content-start gap-2">
                    <div className="search-box me-2 col-sm-10">
                      <Input type="text" className="form-control" placeholder="Search for Articles..." value={searchKeyword} onChange={handleSearchInputChange} />
                      <i className="ri-search-line search-icon"></i>
                    </div>
                  </div>
                </div>

...
const UiModals = () => {
  document.title = "Modals | Psymate - Management Portal";
  ...
  return (
    <React.Fragment>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>modal-dialog</code>class to show default modal.
                  </p>
      ...
      <Modal
        ...
        centered
      >
        <ModalHeader className="modal-title">Center Modal</ModalHeader>

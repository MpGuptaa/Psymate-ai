...
const UiList = () => {
  document.title = "List | Psymate - Management Portal";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>list-group</code> class in an unordered list and{" "}
                    <code>list-group-item</code> class to create a default list
                    group.
                  </p>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>disabled</code> class to{" "}
                    <code>list-group-item</code> to make it <em>appear</em>{" "}
                    disabled.
                  </p>
                  <div className="live-preview">
                    <ListGroup>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>list-group-flush</code> class to remove some
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>list-group-horizontal</code> class to change the
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <code>.list-group-item-action</code>. Note the addition of
                    the hover styles here not present in the previous example.
                  </p>
                  <div className="live-preview">
                    <ListGroup>
                      <ListGroupItem

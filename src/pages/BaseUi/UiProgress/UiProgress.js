...
const UiProgress = () => {
  document.title = "Progress | Psymate - Management Portal";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>progress</code> class to show default progress.
                  </p>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>bg-</code> class to progress bar class with the
          ...
          <Row>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>progress-bar-striped</code>class to add strip to
                    the progress.
                  </p>
                  <div className="live-preview">
                    <div className="mb-4">
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>progress-bar-striped progress-bar-animated</code>{" "}
          ...
          <Row>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>animated-progress</code> class to show progress
                    with animation.
                  </p>
                  <div className="live-preview">
                    <div className="mb-4">
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use{" "}
                    <code>animated-progress custom-progess progress-label</code>{" "}

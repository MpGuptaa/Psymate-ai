...
import TaskTab from "../../Tasks/TaskList/AllTasks";
...
const OverviewTab = ({ itemId }) => {
  ...
  useEffect(() => {
    dispatch(onGetProjectList(searchKeyword, currentPage, projectId));
  }, [dispatch, searchKeyword, currentPage, projectId]);
          ...
          <Card>
            <CardBody>
              <div className="text-muted">
                ...
                {project && (
                  <>
                    <h6 className="mb-3 fw-semibold text-uppercase">{project.displayName}</h6>
                      ...
                      <Row>
                        <Col lg={3} sm={6}>
                          <div>
                            ...
                            <h5 className="fs-15 mb-0">{new Date(project.createdAt).toLocaleString('en-US', { dateStyle: 'short', timeStyle: 'short' })}</h5>
                          </div>
                        </Col>
                        <Col lg={3} sm={6}>
                          <div>
                        ...
                        <Col lg={3} sm={6}>
                          <div>
                            ...
                            <div className="badge bg-warning fs-12">Live</div>
                          </div>
                        </Col>
                      </Row>
                    </div>

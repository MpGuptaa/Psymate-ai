...
const EcommerceOrderDetail = (props) => {
  document.title = "Order Details | Psymate - Management Portal";
  ...
  const getOrder = async () => {
    await axios
      .get(config.api.API_URL + `/orders?invoiceId=${pathName}`)
      .then((res) => {
        setOrder(res.data[0]);
      });
  };
              ...
              <CardHeader>
                <div className="d-flex align-items-center">
                  ...
                  <div className="flex-shrink-0">
                    <Link
                      to={`/apps-invoices-details?id=${order?.invoiceId}`}
                      download={true}
                        ...
                        <td colSpan="2" className="fw-medium p-0">
                          <table className="table table-borderless mb-0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td className="text-end">
                                  ...
                                  {order?.payment?.reduce(
                                    (total, paymentItem) => {
                                      return (
                                        total + parseInt(paymentItem.discount)
                                      );
                                    },
                                    0
                                  )}
                              ...
                              <tr className="border-top border-top-dashed">
                                <th scope="row">
                                  Total ({order?.payment?.[0]?.currency}) :
                                </th>
                    ...
                    >
                      ...
                      >
                        <div className="accordion-body ms-2 ps-5 pt-0">
                          ...
                          <h6 className="mb-1">
                            {order?.company?.establishmentName} has proccessed
                            your order.
                          </h6>
            ...
            <Card>
              ...
              <CardBody>
                <div className="text-center">
                  ...
                  ></lord-icon>
                  <h5 className="fs-17 mt-2">PSYMATE Logistics</h5>
                  <p className="text-muted mb-0">ID: {order?._id}</p>
                  <p className="text-muted mb-0">
                    Payment Mode : {order?.payment?.[0]?.method}
                  </p>
                </div>
              </CardBody>
            </Card>
            ...
            <Card>
              <CardHeader>
                <div className="d-flex">
                  ...
                  <div className="flex-shrink-0">
                    <Link
                      to={`/pages-profile?id=${order?.user?._id}`}
            ...
            <Card>
              ...
              <CardBody>
                <div className="d-flex align-items-center mb-2">
                  <div className="flex-shrink-0">
                    <p className="text-muted mb-0">Invoice Number:</p>
                  </div>
                  <div className="flex-grow-1 ms-2">
                    <h6 className="mb-0">#{order?.invoiceId}</h6>
                  </div>
                </div>
                <div className="d-flex align-items-center mb-2">
                  <div className="flex-shrink-0">
                  ...
                  <div className="flex-grow-1 ms-2">
                    <h6 className="mb-0">{order?.payment?.[0]?.method}</h6>
                  </div>
                </div>
                <div className="d-flex align-items-center">
                  <div className="flex-shrink-0">
                  ...
                  <div className="flex-grow-1 ms-2">
                    <h6 className="mb-0">
                      {order?.payment?.[0]?.currency} {order?.totalAmount}
                    </h6>
                  </div>
                </div>
              </CardBody>

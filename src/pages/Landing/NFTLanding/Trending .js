                      ...
                      <CardBody>
                        <Row className="g-1 mb-3">
                          <Col lg={6}>
                            ...
                            <img
                              src={
                                "https://img.themesbrand.com/Psymate/images/img-2.gif"
                              }
                              alt=""
                          ...
                          <Col lg={6}>
                            <img
                              src={
                                "https://img.themesbrand.com/Psymate/images/img-5.gif"
                              }
                              alt=""
                      ...
                      <CardBody>
                        <Row className="g-1 mb-3">
                          <Col lg={6}>
                            ...
                            <img
                              src={
                                "https://img.themesbrand.com/Psymate/images/img-1.gif"
                              }
                              alt=""
                              className="img-fluid rounded mt-1"
                            />
                          ...
                          <Col lg={6}>
                            <img
                              src={
                                "https://img.themesbrand.com/Psymate/images/img-4.gif"
                              }
                              alt=""
                              className="img-fluid rounded mb-1"
                            />
                      ...
                      <CardBody>
                        <Row className="g-1 mb-3">
                          <Col lg={6}>
                            ...
                            <img
                              src={
                                "https://img.themesbrand.com/Psymate/images/img-3.gif"
                              }
                              alt=""
                              className="img-fluid rounded mt-1"
                            />

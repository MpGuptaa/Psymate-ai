...
const EcommerceManufacturerDetail = () => {
  document.title = "Manufacturers Details | Psymate - Management Portal";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Manufacturer Details" pageTitle="Ecommerce" />
          <Row>
...
export default EcommerceManufacturerDetail;

  ...
  */
              ...
              <div className="d-flex align-items-center">
                ...
                <div className="flex-grow-1">
                  <h5 className="fs-14 mb-1">
                    <Link
                      to={`/apps-new-academy-add-course?id=${course.row.original._id}`}
                      className="text-dark"
                    >
                      {course.row.original.displayName}
                    </Link>
                  </h5>
                  <p className="text-muted mb-0">
                    Access :
                    <span className="fw-medium">
                      {course.row.original.access}
                    </span>
                  </p>
                </div>
              </div>
          ...
          return (
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                ...
                <DropdownItem
                  href={`/apps-new-academy-add-course?id=${cellProps.row.original._id}`}
                >
  ...
  return (
    <div className="page-content">
      ...
      />
      <Container fluid>
        <BreadCrumb title="Courses" pageTitle="Academy" />
        <Col xs={4}>
          <div className="mb-3">

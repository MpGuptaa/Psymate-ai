...
const VectorMaps = () => {
  document.title = "Vector Maps | Psymate - Management Portal";
              ...
              <Card>
                ...
                <CardBody>
                  <div id="usa-vectormap" style={{ height: "350px" }}>
                    <Vector value="us_aea" width="724" color="#5ea3cb" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="canada-vectormap" style={{ height: "350px" }}>
                    <Vector value="ca_lcc" width="500" color="#58caea" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="russia-vectormap">
                    <Vector value="ru_mill" width="500" color="#6ada7d" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="spain-vectormap">
                    <Vector value="es_mill" width="500" color="#7084c7" />
                  </div>
                </CardBody>
              </Card>
            </Col>

...
function AssessmentDetail(props) {
  ...
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Assessment Details" pageTitle="Lab" />
              ...
              <CardBody>
                <Row className="gx-lg-5">
                  <Col xl={4} md={8} className="mx-auto">
                    <div className="assessment-img-slider sticky-side-div">
                      <Swiper
                        navigation={true}
                        thumbs={{ swiper: thumbsSwiper }}
                        className="swiper assessment-thumbnail-slider p-2 rounded bg-light"
                      >
                      ...
                      {/* 
                      <div className="assessment-nav-slider mt-2">
                        <Swiper
                          ...
                          spaceBetween={10}
                          className="swiper assessment-nav-slider mt-2 overflow-hidden"
                        >
                          <div className="swiper-wrapper">
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      <div className="d-flex">
                        ...
                        <div className="flex-shrink-0">
                          <div>
                            ...
                            <a
                              href={
                                "apps-lab-add-assessment?id=" + assessment?._id
                              }
                              id="TooltipTop"
                        ...
                        {[
                          {
                            ...
                            label: "MRP",
                            labelDetail: `RS ${assessment?.mrp}`,
                          },
                          {
                            id: 1,
                            icon: "ri-money-dollar-circle-fill",
                            label: "MRP",
                            labelDetail: `RS ${assessment?.cost}`,
                          },
                          {
                            id: 1,
                            icon: "ri-stack-fill",
                            label: "STOCK",
                            labelDetail: `RS ${assessment?.quantity}`,
                          },
                          {
                            id: 1,
                            icon: "ri-file-copy-2-fill",
                            label: "Selling Price",
                            labelDetail: `RS ${assessment?.sellingRate}`,
                          },
                      ...
                      <div className="assessment-content mt-5">
                        <h5 className="fs-15 mb-3">Assessment Description :</h5>

...
const UiScrollbar = () => {
  document.title = "Scrollbar | Psymate - Management Portal";
  return (
    <React.Fragment>
          ...
          <Row>
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>data-simplebar-auto-hide="false"</code> attribute
                    and add <code>max-height: **px</code> to show simplebar as
                    default.
                  </p>

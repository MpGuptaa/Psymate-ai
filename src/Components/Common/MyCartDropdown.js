            ...
            <Row className="align-items-center">
              ...
              <div className="col-auto">
                <span className="badge badge-soft-warning fs-13">
                  <span className="cartitem-badge"> {cart.total} </span> items
                </span>
              </div>
            </Row>
          </div>
            ...
            <div className="p-2">
              ...
              {cart?.items?.map((item, key) => (
                <div
                  ...
                  key={`short_cart_${item?.product?._id}`}
                >
                  <div className="d-flex align-items-center">
                    <img
                      src={item?.product?.photoURL || image6}
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mb-0 fs-12 text-muted">
                        Quantity:{" "}
                        <span>
                          {item?.quantity} x {item?.product?.sellingRate}
                        </span>
                      </p>
                    </div>
                    <div className="px-2">
